...
const createRetrieveCustomer = async ({ email, uuid }: { email: string; uuid: string }) => {
...
const copyBillingDetaisToCustomer = async (uuid: string, payment_method: Stripe.PaymentMethod) => {
